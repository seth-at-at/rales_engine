...
describe "Ivoice API" do
  ...
  context "find_all" do
    ...
    it "customer_id" do
      ...
      get '/api/v1/invoices/find_all', params:{ customer_id: customer_id }
      invoice = JSON.parse(response.body)
    ...
    it "merchant_id" do
      ...
      get '/api/v1/invoices/find_all', params:{ merchant_id: merchant_id }
      invoice = JSON.parse(response.body)
    ...
    it "status" do
      ...
      get '/api/v1/invoices/find_all', params:{ status: status }
      invoice = JSON.parse(response.body)
